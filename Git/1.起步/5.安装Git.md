...
| Note | 本书写作时使用的 Git 版本为 **2.8.0**。 我们使用的大部分命令仍然可以在很古老的 Git 版本上使用，但也有少部分命令不好用或者在旧版本中的行为有差异。 因为 Git 在保持向后兼容方面表现很好，本书使用的这些命令在 2.8 之后的版本应该有效。 |
| ---- | ------------------------------------------------------------ |
|      |                                                              |
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/git-osx-installer.png)
