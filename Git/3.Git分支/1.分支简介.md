...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/commit-and-tree.png)

Figure 9. 首次提交对象及其树结构

做些修改后再次提交，那么这次产生的提交对象会包含一个指向上次提交对象（父对象）的指针。

![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/commits-and-parents.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/branch-and-history.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/two-branches.png)

Figure 12. 两个指向相同提交历史的分支

那么，Git 又是怎么知道当前在哪一个分支上呢？ 也很简单，它有一个名为 `HEAD` 的特殊指针。 请注意它和许多其它版本控制系统（如 Subversion 或 CVS）里的 `HEAD` 概念完全不同。 在 Git 中，它是一个指针，指向当前所在的本地分支（译注：将 `HEAD` 想象为当前分支的别名）。 在本例中，你仍然在 `master` 分支上。 因为 `git branch` 命令仅仅 **创建** 一个新分支，并不会自动切换到新分支中去。

![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/head-to-master.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/head-to-testing.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/advance-testing.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/checkout-master.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/advance-master.png)
