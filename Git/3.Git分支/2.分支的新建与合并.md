...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/basic-branching-1.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/basic-branching-2.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/basic-branching-3.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/basic-branching-4.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/basic-branching-5.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/basic-branching-6.png)
...
![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/basic-merging-1.png)

Figure 24. 一次典型合并中所用到的三个快照

和之前将分支指针向前推进所不同的是，Git 将此次三方合并的结果做了一个新的快照并且自动创建一个新的提交指向它。 这个被称作一次合并提交，它的特别之处在于他有不止一个父提交。

![img](https://github.com/linl-sec/linlsec.github.io/blob/main/images/Git/basic-merging-2.png)
